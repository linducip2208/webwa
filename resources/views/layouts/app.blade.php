    ...
    <aside :class="sidebar ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-5 space-y-1">
            ...
            @if(auth()->user()->isAdmin())
                ...
                <a href="{{ route('admin.settings') }}" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs('admin.settings') ? 'bg-brand-600 text-white' : 'hover:bg-white/5 hover:text-white' }}">
